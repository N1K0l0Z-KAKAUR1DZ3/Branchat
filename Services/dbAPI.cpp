...
// --- LOAD MODELS IN STRICT BOTTOM-UP ORDER ---
#include "../Models/Message.cpp"
#include "../Models/Root_Chat.cpp"
#include "../Models/Chat.cpp"
#include "../Models/Group.cpp"
#include "../Models/Base.cpp"
#include "../Models/Tree.cpp"
...
class DBAPI {
    ...
    static std::vector<Message> GetTreeMessages(const int RootId) {
    ...
    static std::vector<Message> ExtractChatMessages(const std::vector<Message>& allMessages, const int ChatId) {
    ...
    static std::vector<RootChat> ExtractGroupRoots(const std::vector<RootChat>& allRoots, const int GroupId) {
    ...
    static int GetBranchCount(const int rootId) {
...
public:
    static void init() {
            std::ifstream secretFile("/home/metanika/CLionProjects/Branchat1/Secrets/conString.txt");
            std::string conString;
            std::getline(secretFile, conString);
            std::string connectionString = conString;
            dbConnection = std::make_unique<nanodbc::connection>(connectionString);
    ...
    static ChatTree GetChatTree (const int rootId) {
    ...
    //create
     ...
     static Chat SaveBranchingChat(const std::string& name, const int parentId, const  int rootId, const int groupId) {
    ...
    //update
    static void UpdateGroupName(const int GroupId,  const std::string & newName) {
     ...
     static void UpdateChatName(const int chatId,  const std::string & newName) {
    ...
    //delete
     static void DeleteChat(const int chatId) {
    ...
    static void DeleteGroup(const int groupId) {
